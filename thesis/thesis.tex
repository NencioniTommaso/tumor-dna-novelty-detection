...
% Frontespizio -------------------------------------------------------------------
       \title{Mismatch String Kernel for Novelty Detection on DNA Fragments}
       \author{Tommaso Nencioni}
       ...
       \correlatori{Silvio Conticello \\ Umberto Greco} % i correlatori separati da \\
